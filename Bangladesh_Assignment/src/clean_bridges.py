...
def repair_bridge_location(row, road_dict, road_max_lengths):
    ...
    1. LRP Match (first prio): Matches exact LRP name with road database.
    2. Chainage Match (second prio): Interpolates position based on valid chainage.
    ...
    # HANDLE CHAINAGE ERRORS (km > max_len)
...
def clean_bridges_pipeline(df_bridges, df_roads_clean):
    ...
    # Format for Export (Java Compatibility)
